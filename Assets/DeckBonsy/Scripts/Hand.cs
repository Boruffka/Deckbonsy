...
public class Hand : MonoBehaviour
{
    ...
    public GameObject GetCardObjectByIndex(int index)
    {
        ...
        Debug.LogWarning($"[Hand] Nieprawid�owy index karty: {index}, rozmiar r�ki: {cardObjects.Count}");
        return null;
    }
    ...
    public void AddCardToHand(Card addedCard)
    {
        ...
        {
            Debug.LogWarning("Nie uda�o si� doda� karty � r�ka pe�na.");
            return;
        }
